      ...
      <Container>
        ...
        <Form onSubmit={submit}>
          <Form.Field>
            ...
            <Form.Input placeholder='https://seeth.is' name='url' value={url} onChange={handleUrlChange}/>
          </Form.Field>
          <Form.Field>
            <label>Link Path ("example" would create <a href="https://seeth.is/l/example">seeth.is/l/example</a>)</label>
            <Form.Input placeholder='example' name='link' value={link} onChange={handleLinkChange}/>
