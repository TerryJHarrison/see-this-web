          ...
          <Card>
            ...
            <CardDescription>
              <Segment basic compact textAlign='center'>
                Expects a JSON body with two fields: link and url. Link field can be left blank for an auto-generated path.
              </Segment>
              <Segment inverted textAlign='left'>
                ...
                Generate link:
                <blockquote><pre>{'{'}<br/>&nbsp;&nbsp;"link": "",<br/>&nbsp;&nbsp;"url": "test.com"<br/>{'}'}</pre></blockquote>
              </Segment>
            </CardDescription>
          </Card>
          <Card>
